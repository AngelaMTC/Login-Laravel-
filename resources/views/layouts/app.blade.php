    ...
    <nav class="flex py-5 bg-indigo-500 text-white">
      ...
      @else
        <li class="mx-6">
          ...
          {{-- <a href="{{url('/login/')}}" class="font-semibold hover:bg-indigo-700 py-3 px-4 rounded-md">Log In</a> --}}
        </li>
        <li>
          ...
          {{-- <a href="{{url('/register/')}}" class="font-semibold border-2 border-white py-2 px-4 rounded-md hover:bg-white hover:text-indigo-700">Register</a> --}}
      @endif
      </ul>
    </nav>
